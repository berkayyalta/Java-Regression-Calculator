...
public class M2
{
	 ...
	 *  @return	: Matrix
	 */
	public static Matrix add_column(BigDecimal[] column, Matrix m)
	{
		//Get the variables
	...
	/**
	 *  The method toArrayList converts to given 2D BigDecimal arraylist to 2D
	...
	/**
	 *  The method toArrayList converts to given 2D BigDecimal array to 2D
	 ...
	 */
	public static ArrayList<ArrayList<BigDecimal>> toArrayList(BigDecimal[][] A, int rows, int columns)
	{
